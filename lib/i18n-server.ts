...
const translationModules = {
  kor: {
    ...
    'admin.groups': () => import('@/i18n/kor/admin.groups.json'),
    ...
    'admin.rag': () => import('@/i18n/kor/admin.rag.json'),
    'admin.tools': () => import('@/i18n/kor/admin.tools.json'),
    'admin.users': () => import('@/i18n/kor/admin.users.json'),
  ...
  eng: {
    ...
    'admin.groups': () => import('@/i18n/eng/admin.groups.json'),
    ...
    'admin.rag': () => import('@/i18n/eng/admin.rag.json'),
    'admin.tools': () => import('@/i18n/eng/admin.tools.json'),
    'admin.users': () => import('@/i18n/eng/admin.users.json'),
