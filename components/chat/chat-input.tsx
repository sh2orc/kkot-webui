          ...
          <div className="flex flex-col p-3">
            ...
            <div className="relative flex items-end">
              <textarea
                ...
                className={`w-full rounded-lg border-0 p-2 pr-12 resize-none overflow-hidden focus:outline-none focus:ring-0 text-sm leading-6 h-[48px] min-h-[48px] max-h-[48px] ${isStreaming ? 'opacity-50 cursor-not-allowed' : ''}`}
                value={inputValue}
              ...
              <Button
                variant="default"
                size="icon"
                className={`absolute right-1 bottom-3 h-8 w-8 rounded-full text-white bg-black hover:bg-gray-800 hover:text-white`}
